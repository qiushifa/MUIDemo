var util = {
	options: {
		ACTIVE_SRC0: "images/home_click.png",
		NORMAL_SRC0: "images/home_nor.png",
		ACTIVE_SRC1: "images/schedule_click.png",
		NORMAL_SRC1: "images/schedule_nor.png",
		ACTIVE_SRC2: "images/goods_click.png",
		NORMAL_SRC2: "images/goods_nor.png",
		ACTIVE_SRC3: "images/mine_click.png",
		NORMAL_SRC3: "images/mine_nor.png",
		subpages: [{
			url : 'pages/home.html',
			id : 'home'
		},{
...
//		}
	...
	toggleNview: function(currIndex) {
		...
		switch(currIndex){
			case 0 :{
				util.updateSubNView(0, util.options.ACTIVE_SRC0);
				util.updateSubNView(1, util.options.NORMAL_SRC1);
				util.updateSubNView(2, util.options.NORMAL_SRC2);
				util.updateSubNView(3, util.options.NORMAL_SRC3);
			}	
			break;
			case 1 :{
				util.updateSubNView(0, util.options.NORMAL_SRC0);
				util.updateSubNView(1, util.options.ACTIVE_SRC1);
				util.updateSubNView(2, util.options.NORMAL_SRC2);
				util.updateSubNView(3, util.options.NORMAL_SRC3);
			}
			break;
			case 2 :{
				util.updateSubNView(0, util.options.NORMAL_SRC0);
				util.updateSubNView(1, util.options.NORMAL_SRC1);
				util.updateSubNView(2, util.options.ACTIVE_SRC2);
				util.updateSubNView(3, util.options.NORMAL_SRC3);
			}
			break;
			case 3 :{
				...
				util.updateSubNView(1, util.options.NORMAL_SRC1);
				util.updateSubNView(2, util.options.NORMAL_SRC2);
				util.updateSubNView(3, util.options.ACTIVE_SRC3);
			}
			break;
		}
	},
